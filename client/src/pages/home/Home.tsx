...
export const Home = () => {
  ...
  const prizes = [
    { "title": "Raspberry Pi", "game": "Mars Rover", "competition": "February Competition" },
    { "title": "Bluetooth Headphones", "game": "Mars Rover", "competition": "February Competition" },
    { "title": "Nintendo Switch", "game": "Mars Rover", "competition": "March Competition" },
    ...
    <div className="container">
      ...
      <div className="card bg-secondary-subtle w-100 my-2">
        <div className="card-body pt-1">
          <div className="card-title fw-bold text-center fs-4">Available Prizes</div>
